...
namespace Keyroads.DingtalkSDK
{
    public class DingTalkCrypt
    {
        ...
        public enum DingTalkCryptErrorCode
        {
            /**成功**/
            SUCCESS = 0,
            /**加密明文文本非法**/
        ...
        {
            var dt1 = Convert.ToDateTime("1970-01-01 00:00:00");
            var ts = DateTime.Now - dt1;
        ...
        public class DictionarySort : IComparer
        {
            public int Compare(object oLeft, object oRight)
            {
                ...
                if (string.IsNullOrEmpty(sLeft) || string.IsNullOrEmpty(sRight)) return 0;
